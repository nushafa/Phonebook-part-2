...
#this function will be the first to run as soon as the main function is executed
def initial_phonebook():
    rows, cols = int(input("Please enter the initial number of contacts: ")), 5

#We are collecting thr initial number of contacts the user wants to have in the phonebook already. User may also enter 0 if he doesn't wish to have any.
    phone_book = []
    print(phone book)
    for i in range(rows):
        ...
        temp = []
        for j in range(cols):
            #We have taken the coditions for the values of j only in the personalized fields such as name, number, email id, dob, category etc.
            if j == 0:
...
if choice == 1:
    ...
    query = str(input("Please enter the DOB (in dd/mm/yyyy formant ONLY)\ of the contact you wish to search: "))
    for i in range(len(pb)):
        if query == pb[i][3]:
            check = i
            temp.append(pb[i])
...
def thanks():
    print("****************************************************************************************************")
    print("Thank you for using the Smartphone Directory")
    print("Please visit again!")
    print("****************************************************************************************************")
    sys.exit("Goodbye, Have a nice day!")
print("....................................................................")
print("Hello, dear user! Welcome to the Smartphone Directory")
